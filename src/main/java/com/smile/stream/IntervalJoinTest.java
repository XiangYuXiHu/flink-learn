    ...
    public static void main(String[] args) throws Exception {
        ...
        orderStream.keyBy(data -> data.f0)
                ...
                .process(new ProcessJoinFunction<Tuple3<String, String, Long>, Event, String>() {
                    @Override
                    public void processElement(Tuple3<String, String, Long> stringStringLongTuple3, Event event, Context context, Collector<String> collector) throws Exception {
                        collector.collect("order:" + stringStringLongTuple3 + " ===> click:" + event);
                    }
                })
                .print();
